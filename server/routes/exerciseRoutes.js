...
router.route('/').post(protect, createNewExercise).get(protect, getExercises).put(protect, updateExercise).delete(protect, deleteExercise);

router.route('/log').post(protect, createNewExerciseLog).put(protect, updateExerciseLog);
